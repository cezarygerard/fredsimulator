...
public class FREDmain {
	...
	public static void main(String[] args) {
		...
		UDPSource udpSource = new UDPSource(1,  (long) (0.8 * Constans.link_speed)); 
...
//		nodes.add(tcpSource3);
		...
		Link link1 = new Link(udpSource, fred, (int) ((Constans.second)/500), Constans.link_speed);
		Link link2 = new Link(fred, sink, (int) ((Constans.second)/500), Constans.link_speed );
...
//-------------------------WEZLY DO FREDA--------------------------------	
		RED red = new RED(5);
		UDPSource udpSource6 = new UDPSource(6,  (long) (0.8 * Constans.link_speed)); 
...
//		nodes.add(tcpSource9);
		...
		Link link6 = new Link(udpSource6, red, (int) ((Constans.second)/500), Constans.link_speed);
		Link link7 = new Link(red, sink2, (int) ((Constans.second)/500), Constans.link_speed );
		Link link8 = new Link(tcpSource7, red, (int) ((Constans.second)/500),  Constans.link_speed );
...
//-------------------------~~WEZLY DO FREDA--------------------------------
		...
		long time = 0;	
		while ((time = Timer.increment())<330 * Constans.second)
		{
